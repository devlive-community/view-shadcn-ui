            ...
            '/components/': [
                ...
                (() => {
                    const items = [
                        ...
                        {text: 'QrCode <span class="VPBadge tip">2024.5.3</span>', link: 'view/qr-code'},
                    ]
                    return {
                ...
                (() => {
                    const items = [
                        ...
                        {text: 'Input Tag <span class="VPBadge tip">2024.5.2</span>', link: 'form/input-tag'},
                        {text: 'Map <span class="VPBadge tip">2024.5.2</span>', link: 'form/map'},
                    ]
                    return {
