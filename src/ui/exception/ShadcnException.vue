<template>
  <div class="flex flex-col items-center justify-center min-h-[400px] px-4 space-y-3">
    <div class="mb-6">
      <slot name="icon">
        <!-- 404 Icon -->
        <svg v-if="type === '404'" class="w-24 h-24" viewBox="0 0 24 24" fill="none">
          <!-- Main circle -->
